...
class _MessageScreenState extends State<MessageScreen> {
  ...
  void _configureAndConnect() {
    ...
    _manager.initializeMQTTClient(
        host: "sadeem.eastus.cloudapp.azure.com", identifier: "Flutter_Android");
    _manager.connect();
  }
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                _topicTextController.text="hello";
                  _manager.initializeMQTTClient(
                      host: "sadeem.eastus.cloudapp.azure.com", identifier: "Flutter_Android");
                  _manager.connect();
                  _manager.subScribeTo(_topicTextController.text);
                  //_handleSubscribePress(MQTTAppConnectionState.connectedSubscribed);
